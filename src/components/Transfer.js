   ...
   useEffect(() => {
	...
	const onSubmit = (e) => {
		...
		if (senderAccount?.balance - amount <= 300) {
			return alert(
				`Your current balance GMD${senderAccount.balance}, you are sending GMD${amount}, and your balance will be GMD${senderAccount.balance - amount} which lessthan or equals to the minimum balance GMD200. Your left-over should be morethan GMD200.`
			)
		}
